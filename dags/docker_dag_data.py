...
def get_model(**kwargs):
    ...
    key=f'models/{kwargs["ds"]}_train_out_data.pkl',
    ...
    local_file_path="/home/riste/Documents/Aalto/Advanced_Topic_CS/ApacheAirflow/Docker/data/model.pkl"
...
def build_image(**kwargs):
    ...
    image, build_logs = client.images.build(
        path="/home/riste/Documents/Aalto/Advanced_Topic_CS/ApacheAirflow/Docker/data",
        tag=f'train_out_data:{kwargs["ds"]}',
        buildargs={'PICKLE_FILE_PATH': '/home/riste/Documents/Aalto/Advanced_Topic_CS/ApacheAirflow/Docker/data/model.pkl', 'PORT': '8082'}
    )
    
def stop_and_delete_container(**kwargs):
    client = docker.from_env()
    container_name = 'train_out_data'
...
def start_container(**kwargs):
    ...
    client.containers.run(
        image=f'train_out_data:{kwargs["ds"]}',
        name=container_name,
        detach=True
    )
